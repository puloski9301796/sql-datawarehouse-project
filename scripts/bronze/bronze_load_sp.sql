-- Loading the CSV file to the database and creting a store procedure to execute the code
...
BEGIN
    DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME;
        BEGIN TRY
            ...
            -- Removing the carraige rerturn in gen column----------
            ...
            -- Removing the carriage return in the cntry column
            UPDATE bronze.erp_loc_a101
            SET cntry = REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), '');
            ...
            -- Removing the carriage return in the maintenance column
            UPDATE bronze.erp_px_cat_g1v2
            SET maintenance = REPLACE(REPLACE(maintenance, CHAR(13), ''), CHAR(10), '');
        ...
        BEGIN CATCH
            PRINT '===============================================================';
            PRINT 'ERROR OCCURED DURNG LOADING OF BRONZE LAYER';
